...
const MusicPlayer = ({ title, author, filename, className = '', startAt = 0 }) => {
  ...
  return (
    <div className={clsx(className)}>
      <h1 className="text-2xl font-semibold text-blue-400 mb-5">
        '{title}' <span className="text-xl font-semibold">by {author}</span>
      </h1>
